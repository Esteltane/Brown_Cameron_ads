        ...
        while(gfin == 0) {
            ...
            for (i = 0; i < 6; i++) {
                for (j = 0; j < 7; j++) {
                    ...
                    || (array[i][j] == 1 && array[i+1][j] == 1 && array[i+2][j] == 1 && array[i+3][j] == 1)){
                            p1win = 4;
            ...
            for (i = 0; i < 6; i++) {
                for (j = 0; j < 7; j++) {
                    ...
                    || (array[i][j] == 2 && array[i+1][j] == 2 && array[i+2][j] == 2 && array[i+3][j] == 2)){
                        p2win = 4;
                        //printf("this test:: %d, %d, %d, %d \n" , array[i][j], array[i][j+1] , array[i][j+2] , array[i][j+3] );
                        if(p1win == 4){
                            gfin++;
...
void boardMed() {
    ...
    if (resp == 1) {
        ...
        while (gfin == 0) {
            int temp = 0;
            while (temp == 0) {
                printf("Player 1: %s, Please pick a column you wish to drop your counter (0-8) \n", P1);
                scanf("%d", &counter);
                switch (counter) {
                    case 0:
                        for(int c = 7; c > 0; c--) {
            ...
            temp = 0;
            while (temp == 0) {
                printf("Player 2: %s, Please pick a column you wish to drop your counter (0-8) \n", P2);
                scanf("%d", &counter);
                switch (counter) {
                    case 0:
                        for(int c = 7; c > 0; c--) {
        ...
        printf("Sorry to hear that let me change that for you \n");
    }else{
